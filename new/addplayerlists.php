...
if(isset($_SERVER['HTTP_REFERER'])){
	...
	$backurl = "?view=new/respgames&Season=$season";
}
...
echo "<form method='post' action='?view=new/addplayerlists&amp;Game=".$gameId."'>";

//echo "<table width='600px'><tr><td valign='top' style='width:45%'>\n";
echo "<table><tr><td valign='top' style='width:48%'>\n";
...
echo "<tr><th class='home'>"._("Name")."</th><th class='home right' style='white-space: nowrap' >"._("All")." <input type='checkbox' onclick='checkAll(\"home\");'/></th><th class='home'>"._("Jersey#")."</th></tr>\n";
...
echo "</table></div></td>\n<td style='width:4%'>&nbsp;</td><td valign='top' style='width:48%'>";
...
echo "<tr><th class='guest'>"._("Name")."</th><th class='guest right' style='white-space: nowrap'>"._("All")." <input type='checkbox' onclick='checkAll(\"away\");'/></th><th class='guest'>"._("Jersey#")."</th></tr>\n";
...
echo "<p>&nbsp;</p><p><a href='?view=new/addscoresheet&amp;Game=$gameId'>"._("Feed in score sheet")."</a></p><p>&nbsp;</p>";
