...
if(mysql_num_rows($goals) <= 0){
	...
	$html .= "<a href='?view=touch/scoreboard&amp;Game=$gameId&amp;Team=".$game_result['hometeam']."'>"._("home team")."</a> | ";
	$html .= "<a href='?view=touch/scoreboard&amp;Game=$gameId&amp;Team=".$game_result['visitorteam']."'>"._("guest team")."</a>";
