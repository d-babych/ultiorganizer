...
echo "<form  method='post' action='?view=new/addresult&amp;Game=".$gameId."'>
<table cellpadding='2'>
...
echo "<p>&nbsp;</p><p><a href='?view=new/addplayerlists&amp;Game=".$gameId."'>"._("Feed in the players in the game.")."</a></p>";
