...
function gamerow($gameId, $game){
	...
	if($game['hometeam'] && $game['visitorteam']){
		...
		//$ret .=  "<a href='?view=touch/addspiritfull&amp;Game=$gameId&SpiritReceiver=$game['hometeam']' class='imp'>"._("edit spiritsheets")."</a>";
		$ret .=  "<a href='?view=touch/addspiritfull&amp;Game=$gameId&amp;SpiritReceiver=".$game['hometeam']."' class='imp'>"."edit spiritsheets"."</a>";
		//$ret .=  "<a href='?view=touch/newscoresheet&amp;Game=$gameId'>"."new record scores"."</a> ";
		$ret .=  "<a href='?view=new/newscoresheet&amp;Game=$gameId'>"."new record scores"."</a> ";
