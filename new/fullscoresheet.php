...
if(!empty($_POST['save']))
	...
	for($i=0;$i<$maxscores; $i++)
		...
		if(strcasecmp($pass,'##')==0 || strcasecmp($pass,'#')==0)
			$iscallahan = 1;
...
while($row = mysql_fetch_assoc($scores))
	...
	if (intval($row['iscallahan']))
		{
		echo "<td class='center' style='width:50px;$style_mid'><input class='input' type='tel' onkeyup=\"validNumberX(this);\" id='pass$i' name='pass$i' maxlength='2' size='3' value='##'/></td>";
		}
	else
		{
		...
		echo "<td class='center' style='width:50px;$style_mid'><input class='input' type='tel' onkeyup=\"validNumberX(this);\" id='pass$i' name='pass$i' maxlength='2' size='3' value='$n'/></td>";
		}
	...
	echo "<td class='center' style='width:50px;$style_mid'><input class='input' type='tel' onkeyup=\"validNumber(this);\" id='goal$i' name='goal$i' maxlength='2' size='3' value='$n'/></td>";
	echo "<td style='width:60px;$style_mid'><input class='input' type='tel' onkeyup=\"validTime(this);\" id='time$i' name='time$i' maxlength='8' size='8' value='". SecToMin($row['time']) ."'/></td>";
...
for($i;$i<$maxscores; $i++)
	...
	echo "<td class='center' style='width:50px;$style_mid'><input class='input' type='tel' onkeyup=\"validNumberX(this);\" id='pass$i' name='pass$i' size='3' maxlength='2'/></td>";
	echo "<td  class='center' style='width:50px;$style_mid'><input class='input' type='tel' onkeyup=\"validNumber(this);\" id='goal$i' name='goal$i' size='3' maxlength='2'/></td>";
	echo "<td style='width:60px;$style_mid'><input class='input' type='tel' onkeyup=\"validTime(this);\" id='time$i' name='time$i' maxlength='8' size='8'/></td>";
