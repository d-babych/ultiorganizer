...
YAHOO.util.Event.addListener(window, "load", function() {
    var AcrrIdLoader = function() {
		...
		var memberColumnDefs = [
			{key:"memberId", label:"<?php echo _("Accr. Id"); ?>", sortable:true},
			{key:"Firstname", label:"<?php echo _("First name"); ?>", sortable:true},
			{key:"Lastname", label:"<?php echo _("Last name"); ?>", sortable:true},
			{key:"MembershipYear", label:"<?php echo _("Membership"); ?>", sortable:true},
			{key:"LicenseYear", label:"<?php echo _("License"); ?>", sortable:true},
		...
		memberDataSource.responseSchema = {
	    	resultNode: "Member",
	        fields: [{key:"memberId", parser:"number"}, 
	                 {key:"Firstname"},
	                 {key: "Lastname"},
	                 {key:"MembershipYear", parser:"number"}, 
	                 {key:"LicenseYear", parser:"number"},
	                 {key:"BirthDate"}]
	    };
