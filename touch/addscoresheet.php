...
if(isset($_POST['add']) || isset($_POST['forceadd'])) {
	...
	if(empty($html) || isset($_POST['forceadd'])){
		...
		header("location:?view=touch/addscoresheet&Game=".$gameId);
	}else{
		$errors=true;
	}
...
if(!$errors){
	...
	$html .= "</td></tr><tr><td>\n";
	$html .=  "<a href='?view=touch/addtimeouts&amp;Game=".$gameId."'>"._("Time outs")."</a> | ";
	$html .=  "<a href='?view=touch/addhalftime&amp;Game=".$gameId."'>"._("Half time")."</a>";
	$html .= "</td></tr><tr><td>\n";
	$html .=  "<a href='?view=touch/addfirstoffence&amp;Game=".$gameId."'>"._("First offence")."</a> | ";
	$html .=  "<a href='?view=touch/addofficial&amp;Game=".$gameId."'>"._("Game official")."</a>";
	$html .= "</td></tr><tr><td>\n";
	if(IsTwitterEnabled()){
		$html .=  "<a href='?view=touch/tweet&amp;Game=".$gameId."'>"._("Tweet")."</a> | ";
	}
	if(intval($seasoninfo['spiritpoints'])){
		$html .=  "<a href='?view=touch/addspiritpoints&amp;Game=".$gameId."'>"._("Spirit points")."</a> | ";
	}
