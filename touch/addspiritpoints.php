...
$html .= "</td></tr><tr><td>\n";
$html .= "<input class='input' maxlength='4' size='5' type='text' name='homespirit' id='homespirit' value='". $game_result['homesotg'] ."'/>";
$html .= "</td></tr><tr><td>\n";
$html .= "<b>".utf8entities($game_result['visitorteamname'])."</b> "._("spirit points").":";
$html .= "</td></tr><tr><td>\n";
$html .= "<input class='input' maxlength='4' size='5' type='text' name='awayspirit' id='awayspirit' value='". $game_result['visitorsotg'] ."'/>";
$html .= "</td></tr><tr><td>\n";

$html .= "<input class='button' type='submit' name='save' value='"._("Save")."'/>";
$html .= "</td></tr><tr><td>\n";
$html .= "<a href='?view=touch/addscoresheet&amp;Game=".$gameId."'>"._("Back to score sheet")."</a>";
$html .= "</td></tr>\n";
$html .= "</table>\n";
$html .= "</form>"; 
