...
function mobilePageTop($title) {
  $browser = strpos($_SERVER['HTTP_USER_AGENT'],"Safari") || strpos($_SERVER['HTTP_USER_AGENT'],"iPhone") || strpos($_SERVER['HTTP_USER_AGENT'],"iPod") || strpos($_SERVER['HTTP_USER_AGENT'],"Android");
    if ($browser == true){
    $browser = 'touch';
    }
  ...
  if($browser == 'touch'){
    //echo '<meta name="viewport" content="width=device-width, minimum-scale=1.5, maximum-scale=1.5" />';
    echo '<meta name = "viewport" content = "width=device-width">'."\n";
	echo '<script src="lib/jquery/1.9.1/jquery.min.js"></script>'."\n";
